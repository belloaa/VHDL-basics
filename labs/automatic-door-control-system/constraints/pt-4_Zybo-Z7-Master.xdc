...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { force_open }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
#sset_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { display_select }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
