...
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { segments[6] }]; #IO_L10P_T1_34 Sch=jc_p[1]   		aa	 
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33     } [get_ports { segments[5] }]; #IO_L10N_T1_34 Sch=jc_n[1]		ab     
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { segments[4] }]; #IO_L1P_T0_34 Sch=jc_p[2]         ac     
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { segments[3] }]; #IO_L1N_T0_34 Sch=jc_n[2]         ad     
